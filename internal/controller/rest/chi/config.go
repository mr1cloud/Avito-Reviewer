...
type Config struct {
	Host         string   `yaml:"host" env:"HOST" env-default:"localhost" env-description:"Host is used to attach server"`
	...
	AllowOrigins []string `yaml:"allow_origins" env:"ALLOW_ORIGINS" env-default:"http://*,https://*" env-description:"AllowOrigins is used to set allowed origins for CORS"`
}
